    ...
    public partial class AddTablesSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 10, "Delivered", 50.600000000000001 },
                    { 2, 20, "Open", 40.219999999999999 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, true, 150, "Eyeliner", 10.0, "Test" },
                    { 2, 2, false, 100, "Trousers", 20.0, "Test2" }
                });

            migrationBuilder.InsertData(
                table: "FeedBacks",
                columns: new[] { "Id", "FeedBackDescription", "ProductsId", "Rating" },
                values: new object[] { 1, "Beauty", 1, 40.299999999999997 });

            migrationBuilder.InsertData(
                table: "FeedBacks",
                columns: new[] { "Id", "FeedBackDescription", "ProductsId", "Rating" },
                values: new object[] { 2, "Clothes", 2, 150.40000000000001 });
